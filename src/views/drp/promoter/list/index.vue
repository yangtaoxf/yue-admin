    ...
    <div class="table-container">
      <el-table ref="homeBrandTable"
        ...
        <el-table-column align="center"
                         label="累计客户"
                         width="180"
                         prop="spreadCustomerCount" />

        <el-table-column align="center"
                         label="累计邀请"
                         width="120"
                         prop="spreadInviteCount" />
        <el-table-column align="center"
                         label="累计收益"
                         width="120"
                         prop="spreadProfitAmount" />
        ...
        <el-table-column label="操作"
          ...
          <template slot-scope="scope">
            ...
            <el-button size="mini"
                       type="text"
                       @click="handleUpdate(scope.$index, scope.row)">清退
            </el-button>
          </template>
        </el-table-column>
      </el-table>
...
import { promoterList, updatePromoterApplyStatus } from '@/api/drp'
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      promoterList(this.listQuery).then(response => {
