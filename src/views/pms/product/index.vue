<template> 
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true"
          ...
          <el-form-item label="商品品牌：">
            <el-select v-model="listQuery.brandId"
                       placeholder="请选择品牌"
                       clearable>
          ...
          <el-form-item label="审核状态：">
            <el-select v-model="listQuery.verifyStatus"
                       placeholder="全部"
                       clearable>
      ...
      <el-table ref="productTable"
        ...
        <el-table-column label="标签"
          ...
          <template slot-scope="scope">
            ...
            <p>新品：
              <el-switch @change="handleNewStatusChange(scope.$index, scope.row)"
                         :active-value="1"
                         :inactive-value="0"
    ...
    <el-dialog title="编辑货品信息"
      ...
      <el-input placeholder="按sku编号搜索"
                v-model="editSkuInfo.keyword"
                size="small"
                style="width: 50%;margin-left: 20px">
        <el-button slot="append"
                   icon="el-icon-search"
                   @click="handleSearchEditSku"></el-button>
      </el-input>
      ...
      <span slot="footer"
        ...
        <el-button type="primary"
                   @click="handleEditSkuConfirm">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    getProductSkuSp (row, index, item) {
      let spec = "";
      var specs = JSON.parse(row.specs);
      for (var i in specs) {
        if (specs[i].name == item.name) {
          spec = specs[i].value;
          break;
        }
